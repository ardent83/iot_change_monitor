"""
Django settings for iot_ai_monitor project.
...
# WSGI_APPLICATION = 'iot_ai_monitor.wsgi.application'
ASGI_APPLICATION = 'ai_monitor_project.asgi.application'
...
AUTH_PASSWORD_VALIDATORS = [] # For simplicity in this example
